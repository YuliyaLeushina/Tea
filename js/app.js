(() => {
  ...
  function l(e = {}, t = {}) {
    Object.keys(t).forEach((s) => {
      void 0 === e[s]
        ? (e[s] = t[s])
        : a(t[s]) && a(e[s]) && Object.keys(t[s]).length > 0 && l(e[s], t[s]);
    });
  }
  const o = {
    body: {},
  ...
  function j(e) {
    ...
    if (!s.allowTouchMove)
      return (
        b(o.target).is(i.focusableElements) || (s.allowClick = !1),
        void (
          i.isTouched &&
    ...
    if (
      ...
      b(o.target).is(i.focusableElements)
    )
  ...
  const U = {
      attachEvents: function () {
        ...
        (e.onTouchStart = H.bind(e)),
          ...
          (e.onClick = q.bind(e)),
          i.touch && !R && (t.addEventListener("touchstart", X), (R = !0)),
          Y(e, "on");
      },
  ...
  window.addEventListener("load", function (e) {
    document.querySelector(".galery__slider") &&
      new ne(".galery__slider", {
        modules: [ae, oe],
        observer: !0,
        observeParents: !0,
        slidesPerView: 1,
      ...
      document.querySelector(".headings__slider") &&
        new ne(".headings__slider", {
          modules: [ae, oe],
          observer: !0,
          observeParents: !0,
          slidesPerView: 7,
          ...
          breakpoints: {
            ...
            390: { slidesPerView: 2, spaceBetween: 0 },
            479: { slidesPerView: 3, spaceBetween: 0 },
            768: { slidesPerView: 5, spaceBetween: 0 },
            992: { slidesPerView: 7, spaceBetween: 0 },
            1268: { slidesPerView: 7, spaceBetween: 0 },
          },
          on: {},
        });
  });
