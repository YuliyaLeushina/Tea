(() => {
  ...
  const j = {
    loopCreate: function () {
      ...
      for (let e = 0; e < l.length; e += 1)
        n.append(E(l[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
      for (let e = a.length - 1; e >= 0; e -= 1)
        n.prepend(E(a[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
    },
    loopFix: function () {
      const e = this;
  ...
  function V(e) {
    ...
    if (!s.allowTouchMove)
      return (
        E(o.target).is(i.focusableElements) || (s.allowClick = !1),
        void (
          i.isTouched &&
    ...
    if (
      ...
      E(o.target).is(i.focusableElements)
    )
    ...
    s({
      ...
      i("click", (e, s) => {
        const { $nextEl: i, $prevEl: r } = t.navigation,
          a = s.target;
        if (t.params.navigation.hideOnClick && !E(a).is(r) && !E(a).is(i)) {
          if (
            t.pagination &&
            t.params.pagination &&
    ...
    function c() {
      ...
      if (
        ("fraction" === s.type &&
          ...
          r.find(ue(s.totalClass)).text(s.formatFractionTotal(p))),
        "progressbar" === s.type)
      ) {
        let e;
        ...
        function l(e) {
          ...
          if (t.closest("[data-spoller]")) {
            ...
            r.querySelectorAll("._slide").length ||
              (a && !n.classList.contains("_spoller-active") && o(r),
